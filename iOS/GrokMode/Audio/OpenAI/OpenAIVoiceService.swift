...
class OpenAIVoiceService: VoiceService {
    ...
    ## PAGINATION HANDLING:
    Many tools return paginated results (tweets, DMs, followers, etc.). When you receive paginated results, follow the guides below.
    ...
    - Stop after 5 pages maximum and inform the user. Then ask the user if they would like you to retrieve more - whenever they indicate so, fetch a maximum of 5 more pages.
